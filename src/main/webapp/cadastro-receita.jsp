...
<div class="container">
    <div class="mt-5 ms-5 me-5">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form action="receitas?acao=cadastrar"
                      method="post">
                    ...
                    <div class="form-group">
                        <label for="id-origem">Origem</label>
                        <input type="text" name="origem" id="id-origem" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="id-recebimento">Data de Recebimento</label>
                        <input type="date" name="recebimento" id="id-recebimento" class="form-control">
                    </div>
